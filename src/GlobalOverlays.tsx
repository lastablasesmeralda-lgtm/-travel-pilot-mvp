                ...
                <View style={[s.mf]}>
                    <SafeAreaView style={[s.mc, { width: '90%' }]}>
                        ...
                        {[
                            ...
                            { icon: '✈️', title: 'CONTACTAR AEROLÍNEA', sub: 'Línea directa de tu compañía aérea', color: '#007AFF', action: () => { setShowSOSMenu(false); speak('Conectando con el centro de atención al cliente de tu aerolínea. Mantente a la escucha.'); Alert.alert('AEROLÍNEA', 'Contactando con el servicio de atención al cliente de la aerolínea...'); } },
                            { icon: '🏥', title: 'EMERGENCIA MÉDICA', sub: 'Localizar hospitales y farmacias cercanas', color: '#FF3B30', action: () => { setShowSOSMenu(false); speak('Localizando los servicios médicos y farmacias más cercanos a tu posición actual.'); Alert.alert('EMERGENCIA MÉDICA', 'Buscando servicios médicos cercanos a tu ubicación...'); } },
