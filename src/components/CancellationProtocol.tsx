                ...
                <ScrollView contentContainerStyle={{ padding: 20 }}>
                    <View style={{ backgroundColor: '#0A0A0A', borderRadius: 20, padding: 20, marginBottom: 25, borderWidth: 1, borderColor: '#333' }}>
                        ...
                        <Text style={{ color: '#999', fontSize: 13, lineHeight: 20 }}>
                            Tu vuelo con {airline} ha sido cancelado formalmente. Travel-Pilot ha activado las salvaguardas legales y logísticas para proteger tu viaje.
                        </Text>
                    </View>
                    ...
                    {travelProfile === 'premium' ? (
                        ...
                        <>
                            ...
                            <TouchableOpacity 
                                onPress={() => {
                                    speak('En el plan Premium, yo mismo busco y pre-reser vo tu nuevo vuelo para que llegues a tu destino hoy mismo. ¿Quieres subir de nivel?');
                                    onGoToSubscription();
                                }}
